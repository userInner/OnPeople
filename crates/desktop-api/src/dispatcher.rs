...
use onpeople_types::{
    ...
    GitPushRequest, GitRequest, PreferencePatchRequest, Preferences, SchedulerSnapshot,
    TerminalIdRequest, TerminalResizeRequest, TerminalStartRequest, TerminalWriteRequest,
    ThreadFilters, WorktreeRequest,
};
...
use crate::{
    ...
    ProjectActionAuthorizeRequest, QueuedTaskMessage, RuntimeSnapshotRequest, ShellAppUpdateCheck,
