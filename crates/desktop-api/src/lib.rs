...
pub use protocol::{
    ...
    ConnectorOauthCompleteRequest, DESKTOP_PROTOCOL_VERSION, DesktopBrowserCommand,
    DesktopCapabilities, DesktopEvent, DesktopMethod, DesktopRecoveryRequired, DesktopRequest,
    DesktopResponse, EventReplay, EventReplayRequest, PluginCatalogSyncRequest, PluginIdRequest,
    PluginPayloadRequest, QueuedTaskMessage, RuntimeSnapshotRequest, TaskApprovalResolution,
