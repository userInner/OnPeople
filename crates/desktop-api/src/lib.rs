...
pub use protocol::{
    ...
    AgentProfileSaveRequest, ApprovalDecision, AuthorizedProjectAction, CloudGroupSelectRequest,
    CloudLoginRequest, CloudPayloadRequest, CloudRedeemRequest, CloudRegisterRequest,
    CloudRegistrationCodeRequest, ConnectorOauthCompleteRequest, ContextRequest,
    DESKTOP_PROTOCOL_VERSION, DesktopCapabilities, DesktopEvent, DesktopMethod,
    ...
    LiveCreateRequest, LocalArtifactRequest, MemoryDeleteRequest, MemoryLifecycle,
    MemoryListRequest, MemorySaveRequest, MemorySaveResult, MemorySettingsRequest, MemoryState,
    ModelCatalog, ModelValidation, ModelValidationRequest, NewTaskRequest,
    PluginCatalogSyncRequest, PluginIdRequest, PluginPayloadRequest, PolicySaveRequest,
    PolicyState, ProjectActionAuthorizeRequest, ProjectPathRequest, ProjectUpdateRequest,
    QueuedTaskMessage, QuickLauncherRequest, RuntimeSnapshotRequest, ScheduledTaskFromTextRequest,
    ...
    WorktreePathRequest, export_types, should_forward_desktop_event,
};
